(()=>{
  ...
  function optionHtml(){
    ...
    return `<div class="tpl-card" id="templateSelector"><div class="tpl-title"><span class="req">*</span>选择抽奖样式</div><div class="tpl-options"><div class="tpl-option ${mode==='wheel'?'on':''}" data-tpl="wheel"><div class="tpl-icon">🎡</div><div><div class="tpl-name">大转盘</div><div class="tpl-desc">转盘扇区、指针及旋转动画。</div></div><span class="tpl-tag">选择</span></div><div class="tpl-option ${mode==='gift'?'on':''}" data-tpl="gift"><div class="tpl-icon">🎁</div><div><div class="tpl-name">礼盒抽奖</div><div class="tpl-desc">礼盒开启动效；奖品、权重、库存、资格和发奖逻辑与大转盘共用。</div></div><span class="tpl-tag">选择</span></div></div><div style="margin-top:12px;color:#667085;font-size:13px">仅选择本次活动的前端抽奖样式，不改变随机抽奖模板的后端逻辑。</div></div>`;
  }
