(()=>{
  ...
  function patchBasic(){const body=$('#body');if(!body||$('#templateSelector'))return;const card=body.firstElementChild;if(!card)return;const cardBody=card.querySelector('.card-b');if(!cardBody)return;cardBody.insertAdjacentHTML('afterbegin',optionHtml());bindSelector()}
